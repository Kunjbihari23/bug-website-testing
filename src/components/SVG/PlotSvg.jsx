...
const PlotSvg = () => {
  return (
    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M18 12.5V10.5M6 12.5H12H18H6ZM6 12.5V10.5V12.5ZM6 12.5V14.5V12.5ZM18 12.5V14.5V12.5Z"
        stroke="#091E42"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M12 6.5H14M12 18.5V6.5V18.5ZM12 18.5H14H12ZM12 18.5H10H12ZM12 6.5H10H12Z"
        stroke="#091E42"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
