...
const PetrolPumpSvg = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d="M2 22H19" stroke="#1E1E82" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M6.5 13H9.5" stroke="#1E1E82" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path
